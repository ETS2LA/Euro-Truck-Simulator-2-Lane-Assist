...
def drawButtons():
    ...
    enableButton = helpers.MakeButton(buttonFrame, "Enable", lambda: (variables.ToggleEnable(), enableButton.config(text=("Stop" if variables.ENABLELOOP else "Start"))), 0, 0, width=10, padx=9, style="Accent.TButton")
