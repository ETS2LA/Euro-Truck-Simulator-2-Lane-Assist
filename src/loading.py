...
class LoadingWindow:
    def __init__(self, text:str, master=None, progress:float=False, grab:bool=True, totalProgress:float=-1, height:int=80, width:int=300):
        ...
        Args:
            ...
            width (int, optional): The width of the loading window.
        """
        self.text = text
