...
/** @type {string} */
const CACHE_VERSION = '1729703269|11289331948';
/** @type {string} */
const CACHE_PREFIX = 'ETS2LA Visualisa-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ETS2LA Visualisation.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ETS2LA Visualisation.html","ETS2LA Visualisation.js","ETS2LA Visualisation.offline.html","ETS2LA Visualisation.icon.png","ETS2LA Visualisation.apple-touch-icon.png","ETS2LA Visualisation.worker.js","ETS2LA Visualisation.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["ETS2LA Visualisation.wasm","ETS2LA Visualisation.pck"];
