                ...
                with Tab("Development"):
                    ...
                    with EnabledLock():
                        if self.plugin:
                            ...
                            Switch("Overide Lane Offsets", "Override Lane Offsets", False, description="When enabled the lane offsets will be overridden by the ones in the file. This is useful for testing purposes.")
