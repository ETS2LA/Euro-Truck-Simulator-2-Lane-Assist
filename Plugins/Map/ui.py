    ...
    def render(self):
        ...
        with TabView():
            ...
            with Tab("map.settings.tab.steering.name"):
                Switch("[EXPERIMENTAL]Right-hand traffic", "RightHandTraffic", False, description="When enabled, the plugin will use right-hand traffic rules. This is useful for maps that use right-hand traffic, such as UK or Japan.")
