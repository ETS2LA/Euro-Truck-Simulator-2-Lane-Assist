...
namespace eval ttk::theme::Forest {

    variable version 1.3
    package provide ttk::theme::Forest $version
    variable colors
    array set colors {
        -fg             "#eeeeee"
        -bg             "#313131"
    ...
    LoadImages [file join [file dirname [info script]] Forest]

    # Settings
    ttk::style theme create Forest -parent default -settings {
        ttk::style configure . \
