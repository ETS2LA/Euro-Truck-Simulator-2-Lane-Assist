...
namespace eval ttk::theme::ForestRed {

    variable version 1.3
    package provide ttk::theme::ForestRed $version
    variable colors
    array set colors {
        -fg             "#eeeeee"
        -bg             "#313131"
    ...
    LoadImages [file join [file dirname [info script]] ForestRed]

    # Settings
    ttk::style theme create ForestRed -parent default -settings {
        ttk::style configure . \
