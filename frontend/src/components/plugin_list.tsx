                    ...
                    <AccordionItem value={plugin}>
                        <AccordionTrigger className="pl-3 pr-2 decoration-transparent">
                            <p className="flex gap-3 font-semibold">
                                <p className="text-stone-600 text-xs content-center">{data ? (data as any)[plugin]["frametimes"][(data as any)[plugin]["frametimes"].length - 1] ? Math.round(1/(data as any)[plugin]["frametimes"][(data as any)[plugin]["frametimes"].length - 1]["frametime"]) : "Unknown" : "Unknown"} fps</p> 
                                {plugin}
                            </p>
                        </AccordionTrigger>
