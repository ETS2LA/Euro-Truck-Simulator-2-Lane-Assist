...
class ETS2LAPlugin(object):
    ...
    def before(self) -> None:
        self.plugin_run_begin_time = time.perf_counter()
    ...
    def after(self, data) -> None:
        ...
        time_to_sleep = max(1/self.fps_cap - (self.plugin_run_end_time - self.plugin_run_begin_time), 0)
        if time_to_sleep > 0:
            time.sleep(time_to_sleep)
        
        self.performance.append((self.plugin_run_begin_time, time.perf_counter() - self.plugin_run_begin_time))
