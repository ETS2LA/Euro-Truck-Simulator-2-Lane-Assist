...
class Settings(object):
    ...
    def _load(self):
        try:
            ...
            self.lock = False
            logging.warning(
                "Failed to load settings, you can ignore this if it's not repeating consistently."
            )
    ...
    def _save(self):
        try:
            ...
            self.lock = False
            logging.warning(
                "Failed to save settings, you can ignore this if it's not repeating consistently."
            )
