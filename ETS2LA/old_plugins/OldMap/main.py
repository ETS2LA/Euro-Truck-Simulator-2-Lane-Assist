...
# Plugin imports
from ETS2LA.plugins.OldMap.GameData import roads, nodes, prefabs, prefabItems, cities, companies
import ETS2LA.plugins.OldMap.GameData.extractor as extractor
import ETS2LA.plugins.OldMap.GameData.ferries as ferries
import ETS2LA.plugins.OldMap.Compute.compute as compute
...
def plugin():
    ...
    if COMPUTE_STEERING_DATA:
        ...
        steeringData = plotter.GetSteeringPoints(data, MapUtils, STEERING_ENABLED, navigationData, closestData)
