...
class UI():
    try: # The panel is in a try loop so that the logger can log errors if they occur
        ...
        def exampleFunction(self):
            ...
            helpers.MakeButton(self.root, "ETS2LA Wiki ↗ ", lambda: helpers.OpenInBrowser("https://wiki.tumppi066.fi/en/LaneAssist"), 0, 2, width=20, autoplace=True, tooltip="https://wiki.tumppi066.fi/en/LaneAssist")
            helpers.MakeEmptyLine(self.root, 0, 1, columnspan=2, autoplace=True, fontSize=3)
