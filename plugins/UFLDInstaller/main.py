...
'''
This .zip file contains the following **NVIDIA** cudnn and cuda binaries: 
```
cufft64_10.dll
...
cublas64_11.dll
```
These binaries were not made by me and are property of NVIDIA Corporation.
“This software contains source code provided by NVIDIA Corporation.” 

# By downloading you agree to the following terms:
1. https://docs.nvidia.com/deeplearning/cudnn/sla/index.html
2. https://docs.nvidia.com/cuda/eula/index.html
3. You agree to use the files only as a part of the "Euro-Truck-Simulator-2-Lane-Assist" application.
4. You agree to delete all downloaded files in the case you delete the program.
5. **You are legally responsible for downloading these NVIDIA binaries.**


Additional Notes
These terms follow the NVIDIA guidelines, but I am not a lawyer and thus I have included term 5. 
This means that in the case that you do not follow these terms, or the terms are not sufficient from the start **I am not responsible.**
In addition in the case that I would find out that you are not following these terms **I am legally bound to report it to NVIDIA.**

It is important to not that as in with the guidelines by NVIDIA  *"Additionally, you agree that you will protect the privacy, security and legal rights of your application users."* my application does not log any user data. The files are hosted on MEGA, that also logs no identifiable user data.

Important

Place the files in the .zip to `app/src/NVIDIA/`
Information on how to download the files directly from NVIDIA is available in `app/src/NVIDIA/Information.txt`

By downloading you agree to the terms above. Please read them carefully!
'''