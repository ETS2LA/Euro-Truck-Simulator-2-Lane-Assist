...
# The autumnorange theme is a beautiful modern ttk theme inspired by Microsoft's fluent design.

package require Tk 8.6

namespace eval ttk::theme::autumnorange-light {
    variable version 2.0
    package provide ttk::theme::autumnorange-light $version

    ttk::style theme create autumnorange-light -parent clam -settings {
