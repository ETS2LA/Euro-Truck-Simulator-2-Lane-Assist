...
namespace eval ttk::theme::autumnorange-dark {
    variable version 2.0
    package provide ttk::theme::autumnorange-dark $version

    ttk::style theme create autumnorange-dark -parent clam -settings {
